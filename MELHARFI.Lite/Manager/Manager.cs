...
namespace MELHARFI.Lite.Manager
{
    ...
    public partial class Manager
    {
        ...
        public Manager(Control control, string instanceName)
        {
            Control = control;
        ...
        private void GetSubControls(Control control)
        {
            typeof(Panel).InvokeMember("DoubleBuffered", BindingFlags.SetProperty | BindingFlags.Instance | BindingFlags.NonPublic, null, control, new object[] { true });

            foreach (Control _control in control.Controls)
            {
                GetSubControls(_control);
                typeof(Panel).InvokeMember("DoubleBuffered", BindingFlags.SetProperty | BindingFlags.Instance | BindingFlags.NonPublic, null, _control, new object[] { true });
